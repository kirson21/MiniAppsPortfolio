...
const resources = {
  ...
  ru: {
    translation: {
      title: "Разработчик веб / мобильных приложений",
      titleSeparator: "|",
      subtitle: "Kirson's Portfolio",
      mainSubtitle: "Примеры интерактивных приложений, которые я могу сделать для вашего бизнеса",
      ...
      carento: {
        ...
        subtitle: "Профессиональный и современный веб-сайт для вашего бизнеса по аренде автомобилей или автосалона"
      },
      maxton: {
